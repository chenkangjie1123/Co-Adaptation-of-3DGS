...
dataset_name = "DTU"
data_base_path='./data/DTU_colmap'
...
dropout_factor = 0.3 # 0.3 or 0.2
sigma_noise = 0.0 # 0.05
...
for scene in scenes:
    model_path1 = f"{out_base_path}/scan{scene}_{n_views}views"
    os.makedirs(model_path1, exist_ok=True)

def train_block(gpu_id, scene):
       log_file = f"{out_base_path}/scan{scene}_{n_views}views/log.txt"
